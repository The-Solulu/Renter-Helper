...
function RenterInfo() {
  const questions = [
    ...
    { key: 'birthday', question: 'Birthday (MM/DD/YYYY)' },
    { key: 'profileBio', question: 'Profile Bio' },
    { key: 'major', question: 'Major' },
    { key: 'interests', question: 'Interests' },
    { key: 'pronouns', question: 'Pronouns' },
    { key: 'sleepStart', question: 'Sleep Start' },
  ];
